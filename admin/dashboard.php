...
<section class="summary-grid" aria-label="System summary">
    ...
    <article class="summary-card"><div class="summary-top"><span>TOTAL PRODUCTS</span><span class="summary-icon"><i class="fa-solid fa-bread-slice"></i></span></div><div class="summary-value"><?php echo $totalProducts; ?></div></article>

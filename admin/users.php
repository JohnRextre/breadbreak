...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'create_user') {
        ...
        if (!in_array($formData['role'], ['admin', 'staff', 'customer'], true)) $errors['role'] = 'Please select a valid role.';

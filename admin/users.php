...
?>
<section class="page-intro users-page-intro"><div><h2>User Management</h2><p>Manage administrator, staff, and customer accounts.</p></div><button class="admin-button primary" type="button" data-open-modal="add-user-modal"><i class="fa-solid fa-user-plus"></i> Add New User</button></section>
